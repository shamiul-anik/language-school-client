      ...
      <div className="modal">
        <div className="modal-box w-11/12 max-w-5xl !overflow-y-hidden">
          ...
          <div className='text-slate-600 mt-4 text-justify pr-4 overflow-y-auto max-h-[calc(100dvh-300px)]'>
            <p className="mb-3 font-bold text-lg">Welcome to Language School!</p>
            ...
            <div className='mt-3'>
              ...
              <p>All content on the Language School website, including text, images, videos, and other materials, is intended for personal use only. Reproduction, modification, distribution, or any other use of the content without our prior written consent is strictly prohibited.</p>

              <p className='font-semibold underline underline-offset-2 mt-2'>2. Language Learning Programs:</p>
              <p>While we strive to provide accurate and reliable information about our language learning programs, we cannot guarantee the completeness or accuracy of the information. Language School shall not be held responsible for any damages or losses arising from the use of such information.</p>

              <p className='font-semibold underline underline-offset-2 mt-2'>3. Third-Party Links:</p>
              <p>Our website may contain links to third-party websites that are beyond our control. Language School is not responsible for the content or privacy practices of these external sites. It is advisable to review the terms and conditions and privacy policies of any linked websites you visit.</p>
              ...
              <p>We reserve the right to modify these terms and conditions at any time without prior notice. Your continued use of the Language School website signifies your acceptance of the updated terms and conditions.</p>

            </div>

            <p className='mt-4'>If you have any questions or concerns regarding these terms and conditions, please contact us at <br /> <span className='text-blue-700'>info@language-school.com</span>.</p>
            <p className='mt-2'>Thank you for choosing Language School as your foreign language learning summer camp destination!</p>
