  ...
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto mt-4 lg:mt-8 p-4 md:px-0">
        ...
        {/* <div>
          <h1 className="text-2xl font-bold text-teal-600 underline underline-offset-8 text-center mb-6">All Instructors: {allApprovedClasses?.length}</h1>
        </div> */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-8 mt-8">
          ...
          <div className="flex card card-compact w-full bg-base-100 box-shadow-custom group" data-aos="zoom-in">
            <LazyLoad offset={500}>
              <figure className='rounded-t-xl'>
                <img className='overflow-hidden h-80 w-full object-cover rounded-t-xl transition duration-300 group-hover:scale-110' src="https://i.ibb.co/KxFHsB4/image4.jpg" alt="Teacher Name" />
              </figure>
            </LazyLoad>
            <div className='border-t border-slate-300 mb-1'></div>
            <div className="flex-1 p-4 pt-4 pb-0">
              <h3 className='text-center text-xl text-slate-700 font-bold'>Instructor's Name</h3>
              <p className='font-medium text-sm text-center mt-2 mb-2 text-slate-600'>instructor@language-school.com</p>
            </div>
          ...
          <div className="flex card card-compact w-full bg-base-100 box-shadow-custom group" data-aos="zoom-in">
            <LazyLoad offset={500}>
              <figure className='rounded-t-xl'>
                <img className='h-80 w-full object-cover rounded-t-xl transition duration-300 group-hover:scale-110' src="https://i.ibb.co/KxFHsB4/image4.jpg" alt="Teacher Name" />
              </figure>
            </LazyLoad>
            <div className='border-t border-slate-300 mb-1'></div>
            <div className="flex-1 p-4 pt-4 pb-0">
